...
MissionCondition1 = [ "WIN", { false }, "POW number >= 7" ];
MissionCondition3 = [ "WIN1", { false }, "POW number > 12" ];
MissionCondition4 = [ "WIN2", { false }, "POW number > 16" ];
MissionCondition5 = [ "FAIL", { false }, "POW number < 7" ];
